...
conclusion_type = (Door, Fridge, Drawer, Container, set, list, Cabinet, Handle,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Door, Fridge, Drawer, Container, Cabinet, Handle]]:
